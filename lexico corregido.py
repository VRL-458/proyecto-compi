...
# Palabras reservadas
palabras_reservadas = [
    'HOLA', 'ADIOS', 'SI', 'ENTONCES', 'PORFA', 'SINO', 'MIENTRAS', 'HAZ', 'LEE', 'ESCRIBE', '(', ')', 'ASIGNA', '='
]
...
TOKEN_OPERADOR_ARITMETICO = 'operador-aritmetico'
TOKEN_OPERADOR_COMPARACION = 'operador-comparacion'
...
def analizar_lexico(codigo):
    ...
    while posicion < len(codigo):
        ...
        if token is not None:
            ...
            tupla_invertida = token[::-1]
            tokens_encontrados.append(tupla_invertida)
